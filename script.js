...
// с помощью деструктуризации мы можем брать из массивов (обьектов) только те элементы которые нам нужны и игнорируем не нужное


// задача 1 -У вас є 2 масиви рядків, у кожному з них – прізвища клієнтів. Створіть на їх основі один масив, який буде об'єднання двох масивів без повторюваних прізвищ клієнтів.
...
/*задача 2 - Перед вами массив characters, що складається з об'єктів. Кожен об'єкт описує одного персонажа.
...
const { name: nameUser, years: yearsUser, isAdmin = false } = user1;

console.log(`Ім'я: ${nameUser}, Вік: ${yearsUser}, isAdmin: ${isAdmin}`);
